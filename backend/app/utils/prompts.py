...
# Enhanced code feedback prompt for Ollama
...
1. **Correctness**: Does the code produce the expected results?
2. **Efficiency**: Are there any performance or optimization opportunities?
3. **Style**: Does the code follow good Python practices?
4. **Specific Improvements**: What specific changes would make the code better?

Keep the feedback constructive, educational, and actionable.
"""
