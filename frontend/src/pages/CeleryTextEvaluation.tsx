...
const CeleryTextEvaluation: React.FC = () => {
  const {
    submissionFile,
    idealFile,
    error,
  ...
  return (
    <div className="text-evaluation">
      <h1>🚀 Text Q&A Evaluation (Celery - Parallel Processing)</h1>
      <p className="description">
        Upload DOCX files containing Q&A pairs to evaluate student submissions against ideal solutions using parallel processing.
      </p>
      <div className="evaluation-form">
        ...
        <div className="form-actions">
          ...
          >
            {isEvaluating ? 'Evaluating...' : 'Evaluate Text (Celery)'}
          </button>
...
export default CeleryTextEvaluation;
